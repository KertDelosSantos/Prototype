<%@ Page Title="" Language="C#" MasterPageFile="StudentMaster.master" AutoEventWireup="true" CodeBehind="Inbox.aspx.cs" Inherits="Prototype.Hope.Student.Inbox" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- Additional CSS for inbox styling can be placed here -->
</asp:Content>
